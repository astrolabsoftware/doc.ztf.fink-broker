...
-   __Science Portal__
    ...
    The [Science Portal](https://ztf.fink-portal.org) relies on a REST API that queries the Fink Database, which contains aggregated data organized into [column families](../services/search/definitions.md) based on data provenance. For more details, you can refer to the [DB schema](https://api.ztf.fink-portal.org/api/v1/schema).

-   __REST API__

    ---

    The [REST API](../services/search/getting_started.md) queries the Fink Database, which contains aggregated data organized into [column families](../services/search/definitions.md) based on data provenance. For more details, you can refer to the [DB schema](https://api.ztf.fink-portal.org/api/v1/schema).
