!!! info "List of arguments"
    The list of arguments for accessing statistics can be found at [https://api.ztf.fink-portal.org](https://api.ztf.fink-portal.org).

The [statistics](https://ztf.fink-portal.org/stats) page makes use of the REST API.
