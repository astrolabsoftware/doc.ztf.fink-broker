...
!!! info "What are the available fields in Fink?"
    The list of available fields through the API can be found at [https://api.ztf.fink-portal.org/api/v1/schema](https://api.ztf.fink-portal.org/api/v1/schema).

    You can programmatically access the list of all the fields using e.g.:

    ```bash
    curl -H "Content-Type: application/json" -X GET \
        https://api.ztf.fink-portal.org/api/v1/schema -o fink_schema.json
    ```
...
- `d:` added values from [Fink Science modules](../../broker/science_modules.md) ([schema](https://api.ztf.fink-portal.org/api/v1/schema))
- `v:` added values from Fink generated at the query runtime ([schema](https://api.ztf.fink-portal.org/api/v1/schema))
- `b:` cutout data ([schema](https://api.ztf.fink-portal.org/api/v1/schema))
