!!! info "List of arguments"
    The list of arguments for retrieving tracklet data can be found at [https://api.ztf.fink-portal.org](https://api.ztf.fink-portal.org)
...
curl -H "Content-Type: application/json" -X POST \
    ...
    https://api.ztf.fink-portal.org/api/v1/tracklet -o trck_20210810.csv

# you can also specify parameters in the URL, e.g. with wget:
wget "https://api.ztf.fink-portal.org/api/v1/tracklet?date=2021-08-10&output-format=json" -O trck_20210810.json
```
...
r = requests.post(
  "https://api.ztf.fink-portal.org/api/v1/tracklet",
  json={
    "date": "2021-08-10",
    "output-format": "json"
  }
