...
!!! info "List of arguments"
    The list of arguments for retrieving known SSO data can be found at [https://api.ztf.fink-portal.org](https://api.ztf.fink-portal.org)
...
curl -H "Content-Type: application/json" -X POST -d '{"n_or_d":"8467", "output-format":"csv"}' https://api.ztf.fink-portal.org/api/v1/sso -o 8467.csv

# you can also specify parameters in the URL, e.g. with wget:
wget "https://api.ztf.fink-portal.org/api/v1/sso?n_or_d=8467&output-format=json" -O 8467.json
```
...
!!! info "List of arguments"
    The list of arguments for retrieving alert data can be found at [https://api.ztf.fink-portal.org](https://api.ztf.fink-portal.org) (`/api/v1/ssoft` endpoint), and the schema of the table (json) can be found at [https://api.ztf.fink-portal.org/api/v1/ssoft?schema=True](https://api.ztf.fink-portal.org/api/v1/ssoft?schema=True)
...
curl -H "Content-Type: application/json" -X POST \
    ...
    https://api.ztf.fink-portal.org/api/v1/ssoft -o ssoft.parquet
```
...
or view it in your browser at [https://api.ztf.fink-portal.org/api/v1/ssoft?schema=True](https://api.ztf.fink-portal.org/api/v1/ssoft?schema=True).
...
```bash
# using name
curl -H "Content-Type: application/json" -X POST -d '{"output-format":"json", "sso_name": "Autonoma"}' https://api.ztf.fink-portal.org/api/v1/ssoft

# using number
curl -H "Content-Type: application/json" -X POST -d '{"output-format":"json", "sso_number": "1465"}' https://api.ztf.fink-portal.org/api/v1/ssoft
```
...
Idem for the schema of the table: [https://api.ztf.fink-portal.org/api/v1/ssoft?flavor=HG&schema=True](https://api.ztf.fink-portal.org/api/v1/ssoft?flavor=HG&schema=True).
...
!!! info "List of arguments"
    The list of arguments for retrieving SSO candidate data can be found at [https://api.ztf.fink-portal.org/api/v1/ssocand](https://api.ztf.fink-portal.org/api/v1/ssocand)
...
r = requests.post(
  "https://api.ztf.fink-portal.org/api/v1/ssocand",
  json={
    "kind": str, # (1)!
    "ssoCandId": int, # (2)!
    "start_date": str, # (3)!
