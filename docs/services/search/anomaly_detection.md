!!! info "List of arguments"
    The list of arguments for retrieving anomalous alerts can be found at [https://api.ztf.fink-portal.org](https://api.ztf.fink-portal.org)
...
r = requests.post(
  "https://api.ztf.fink-portal.org/api/v1/anomaly",
  json={
    "n": int, # (1)!
    "start_date": str, # (2)!
    "stop_date": str, # (3)!
