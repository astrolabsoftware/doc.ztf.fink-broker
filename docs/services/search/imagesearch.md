!!! info "List of arguments"
    The list of arguments for retrieving cutout data can be found at [https://api.ztf.fink-portal.org](https://api.ztf.fink-portal.org)
...
curl -H "Content-Type: application/json" \
    ...
    https://api.ztf.fink-portal.org/api/v1/cutouts -o cutoutScience.png

# you can also specify parameters in the URL, e.g. with wget:
wget "https://api.ztf.fink-portal.org/api/v1/cutouts?objectId=ZTF21aaxtctv&kind=Science" -O ZTF21aaxtctv_Science.png
```
...
curl -H "Content-Type: application/json" \
    ...
    https://api.ztf.fink-portal.org/api/v1/cutouts -o cutoutScience.fits
```
...
Note there has been a change of syntax recently ([2024-11-25-cutout-handling](https://doc.ztf.fink-broker.org/troubleshooting/#2024-11-25-api-cutout-handling)). You can also request the 3 cutouts in one call now by specifying `kind=All`:
